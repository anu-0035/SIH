...
def find_nearest_post_office(address_latitude, address_longitude, post_offices_df):
    """
    Finds the nearest post office based on Haversine distance.
...
# Example usage:
address = "New ND-25/7 JKPM Colony,Jaykaypur,Rayagada, Odisha"
...
if latitude and longitude and postal_code:
    ...
    post_offices_df = pd.read_csv("pincode1.csv")  # Replace with your CSV file

    # Filter post offices by postal code
    filtered_post_offices = post_offices_df[post_offices_df['Pincode'] == int(postal_code)]
